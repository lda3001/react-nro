...
class Wasm {
  static processAsync = (param1, param2, generatorFunction) =>
...
// Move the IIFE outside the class definition
(() => {
  const ErrENOSYS = () => {
  ...
  globalThis.Go = class {
    ...
    run(_0x3a3ab2) {
      return Wasm.processAsync(this, null, function* () {
 ...
 * @returns 
 */
  export function loadWasm(wasmBytes, requestData, args1) {
  return Wasm.processAsync(this, null, function* () {
    const go = new Go();
...
// Controller Express để sử dụng loadWasm
